    ...
    return (
      <div ref={ref} className="space-y-3">
        ...
        <div
          {...getRootProps()}
          className={cn(
            "p-8 border-2 border-dashed rounded-lg cursor-pointer transition-all bg-slate-800/30",
            isDragActive
        ...
        >
          ...
          <div className="text-center">
            <CloudArrowUpIcon className="w-12 h-12 text-slate-500 mx-auto mb-3" />
            {isDragActive ? (
            ...
            >
              {value.map((file, index) => (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                  className="flex items-center gap-3 p-3 bg-slate-800/50 border border-slate-700/50 rounded-lg group hover:border-violet-500/30 transition-all"
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-violet-500/20 rounded-lg flex items-center justify-center">
                    <DocumentIcon className="w-5 h-5 text-violet-400" />
                  </div>
                  ...
                  <button
                    ...
                    className="flex-shrink-0 p-1.5 rounded-lg hover:bg-red-500/20 text-slate-400 hover:text-red-400 transition-all opacity-0 group-hover:opacity-100"
                  >
